...
public:
    ...
    bool serialOpen(QString portName,int baundrate,int parity,int control);
    bool serialOpen(QString portName, int baundrate, int parity, int stopBits, int control);
    void SerialClose();
    bool serialIsOpen();
